...
class SRPHelperTests {
    private val privateA =
        BigInteger.parseString(
            string = "9488887383906780169920975115798309747280340386237614989425790548298032630501412070884132" +
    ...
    private val publicA =
        BigInteger.parseString(
            string = "11192474286840334471722978684986209783175488578992296589467453128630265626913161504063468" +
    ...
    private val srpB = BigInteger.parseString(
        string = "e05d0716c6f6bf2b96e4b08354015be28024b4bc9a022c3c7553b86a5feffe8ee0ae87ae8ebb970b9457ed56ef0f5249fad4b9" +
    ...
    private val uExpected = BigInteger.parseString("55210528188551933294168660600273656944094602294020021251326310004904436019280", 10)
    private val xExpected = BigInteger.parseString("35002972281322559225995282163712515452164094971035196098842264315967202596678", 10)
    private val sExpected =
        BigInteger.parseString(
            string = "511345472632077986735986885089071610653969805450786791939125627692790536134000082759348192" +
    ...
    fun testComputePAK() {
        ...
        assertEquals(keyExpected, Base64.encode(keyActual))
    }
